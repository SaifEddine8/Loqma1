                      ...
                      TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          hintText: selectedAddress == null
                              ? currentUser.location?.address??'Selected Location'
                  ...
                  onPressed: () {
                    if (_formkey.currentState!.validate()) {
                      UserModel updatedUser = UserModel(
                        id: currentUser.id, // تأكد من إرسال الـ id حتى يطابق بشكل صحيح في القائمة
                        fullName: fullNameController.text.isNotEmpty ? fullNameController.text : currentUser.fullName,
                        password: currentUser.password, 
                        email: emailController.text.isNotEmpty ? emailController.text : currentUser.email,
                        phone: phoneController.text.isNotEmpty ? phoneController.text : currentUser.phone,
                        ...
                        type: selectedType ?? currentUser.type, // الحفظ هنا
                      );
      
                      int userIndex = users.indexWhere((user) => user.id == currentUser.id);
